...
-- Prerrequisitos: shell FLIT (identity.users vía flit-shell-schema.sql).
-- Aplicar: psql -f scripts/sql/tramites/9437-rgl01-procedures-config-rules.sql
...
-- Bootstrap mínimo para FK y pruebas (idempotente)
DO $$
DECLARE
