...
import { useExportDashboardExcel } from "../api/dashboard.api.js";
...
export function ExportExcelButton({ params, disabled = false }: ExportExcelButtonProps) {
  const exportMutation = useExportDashboardExcel();
