  ...
  if (isLoading) {
    return (
      <section
        ...
        className="rounded-lg border border-flit-border p-4 dark:border-flit-border-dark"
      >
        <div
          className="h-6 w-48 animate-pulse rounded bg-flit-border/40"
          aria-busy="true"
          aria-label="Cargando vendedores secundarios"
        />
      </section>
    );
  }
    ...
    <section className="rounded-lg border border-flit-border dark:border-flit-border-dark">
      ...
      {expanded ? (
        <div
          ...
          role="region"
          aria-labelledby={headingId}
          className="border-t border-flit-border px-4 py-3 dark:border-flit-border-dark"
        >
          {sellers.length === 0 ? (
